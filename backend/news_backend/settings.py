...
# Sendcorex HTTP API (used instead of SMTP, since Render's free tier blocks
# outbound SMTP ports 25/465/587 - see backend/api/email_service.py)
SENDCOREX_API_KEY = os.getenv('SENDCOREX_API_KEY', '')
SENDCOREX_FROM_EMAIL = os.getenv('SENDCOREX_FROM_EMAIL', '')
SENDCOREX_FROM_NAME = os.getenv('SENDCOREX_FROM_NAME', 'InfoCred')
